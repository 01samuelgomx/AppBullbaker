...
<<<<<<< HEAD
  ...
  return (
    ...
    <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.dashView}>
  ...
  return (
    <ScrollView contentContainerStyle={styles.dashView}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerItem}>
            <TouchableOpacity style={styles.profile} onPress={() => navigation.navigate("Perfil")}>
              <Image style={styles.profileIcon} source={require("./../../img/icons/user.png")} />
            </TouchableOpacity>
        ...
        <View style={styles.containerCurso}>
          ...
          <View style={styles.infoCursos}>
            <Text style={styles.cursoTittle}>Cookies Perfeitos</Text>
            <Text style={styles.cursoText}>Descubra como fazer cookies crocantes por fora e macios por dentro, com sabores diversos e dicas para o resultado ideal.</Text>
        ...
        <View style={styles.containerCurso}>
          ...
          <View style={styles.infoCursos}>
            <Text style={styles.cursoTittle}>Bolos Profissionais</Text>
            <Text style={styles.cursoText}>Domine técnicas avançadas para preparar, montar e decorar bolos perfeitos, transformando sua paixão em uma carreira de sucesso.</Text>
        ...
        <View style={styles.containerCurso}>
          ...
          <View style={styles.infoCursos}>
            <Text style={styles.cursoTittle}>Arte com Pasta americana</Text>
            <Text style={styles.cursoText}>Aprenda a criar decorações impressionantes e sofisticadas com pasta americana, ideal para todos os níveis de habilidade.</Text>
